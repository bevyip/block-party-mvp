...
const SidePanel = forwardRef<SidePanelHandle, SidePanelProps>(
  function SidePanel(
    {
      onSpriteConfirm,
      isSpawning,
    ...
    const [stage3aRawBase64, setStage3aRawBase64] = useState<string | null>(
      null,
    );
    ...
    useEffect(() => {
      const allDone = ANIM_STATE_ORDER.every(
        (s) => animStatePhase[s] === "done",
      );
    ...
    const handleDrop = useCallback(
      (e: React.DragEvent<HTMLDivElement>) => {
        ...
        e.stopPropagation();
        if (
          processingState === ProcessingStatus.PROCESSING ||
          spritePipelineBusy
        )
          return;
